                ...
                <form onSubmit={handleSubmit} className="space-y-6 mt-4">
                    ...
                    <div
                        ...
                        className={cn(
                            ...
                            isDragging
                                ...
                                : "border-gray-300 dark:border-slate-700 bg-gray-50 dark:bg-slate-900/50 hover:bg-gray-100 dark:hover:bg-slate-900",
                    ...
                    >
                        {file ? (
                            <div className="text-center">
                                ...
                                <p className="text-slate-900 dark:text-indigo-300 font-medium text-sm">{file.name}</p>
                            </div>
                        ) : (
                            <div className="text-center">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-700 focus:ring-indigo-500"
                        />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-3">
                            <Button
                                ...
                                variant="secondary"
                                onClick={() => fileInputRef.current?.click()}
                                className="bg-black dark:bg-indigo-600 hover:bg-gray-800 dark:hover:bg-indigo-500 text-white border-0"
                            >
                                Choose File
                            </Button>
                    ...
                    <DialogFooter className="gap-2 sm:gap-0">
                        <Button
                            ...
                            variant="outline"
                            onClick={onClose}
                            className="border-gray-200 dark:border-slate-700 hover:bg-gray-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300"
                        >
                            Cancel
                        </Button>
                        <Button
                            ...
                            className="bg-black dark:bg-indigo-600 hover:bg-gray-800 dark:hover:bg-indigo-500 text-white min-w-[80px]"
                        >
                            {isUploading ? (
